...
<body>
  ...
  INNER JOIN polis ON nasabah.no_polis = polis.no_polis");
    ...
    <td align='center'><a href = 'nasabah_u.php?update=$tampil[id_nasabah]'>
        <input type='button' value='Edit'>
      </a>
    </td>
    <td align='center'><a href ='?hapus=$tampil[id_nasabah]' onClick=\"return confirm('Anda yakin menghapus data ini?');\">
